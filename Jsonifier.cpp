...
std::map<uint8_t, std::string> createExchangeTypeMap()
{
    ...
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeComposite, "0") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNYSEMKT, "1") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNASDAQBX, "2") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNSE, "3") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityFINRA, "4") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityCQS, "5") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityISE, "6") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityEDGA, "7") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityEDGX, "8") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityCSE, "9") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNYSE, "10") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNYSEARCA, "11") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNASDAQ, "12") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityCTS, "13") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityOTC, "14") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNNOTC, "14") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityOTCBB, "14") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityIEX, "15") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityCBOE, "16") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityNASDAQPHLX, "17") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityBATSY, "18") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeEquityBATS, "19") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeForex, "20") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionNYSEAMEX, "21") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionBOSTON, "22") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionCBOE, "23") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionEDGX, "24") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionISEGEMINI, "25") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionISE, "26") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionISEMERCURY, "27") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionMIAMI, "28") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionNYSEARCA, "29") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionOPRA, "30") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionMIAXPEARL, "31") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionNASDAQ, "32") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionNASDAQBX, "33") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionC2, "34") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionNASDAQPHLX, "35") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeOptionBATS, "36") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeIndexCBOE, "37") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeFutureCBOT, "38") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeFutureCME, "39") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeFutureNYMEX, "40") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeFutureCOMEX, "41") );
    exchangeTypeToStr.insert( std::pair<uint8_t, std::string>(ExchangeFutureKCBT, "42") );
