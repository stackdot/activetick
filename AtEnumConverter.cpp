...
AtEnumConverter::AtEnumConverter() {
    ...
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeComposite", ExchangeComposite) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityNYSEMKT", ExchangeEquityNYSEMKT) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityNASDAQBX", ExchangeEquityNASDAQBX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityNSE", ExchangeEquityNSE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityFINRA", ExchangeEquityFINRA) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityCQS", ExchangeEquityCQS) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityISE", ExchangeEquityISE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityEDGA", ExchangeEquityEDGA) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityEDGX", ExchangeEquityEDGX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityCSE", ExchangeEquityCSE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityNYSE", ExchangeEquityNYSE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityNYSEARCA", ExchangeEquityNYSEARCA) );
    ...
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityBATSY", ExchangeEquityBATSY) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeEquityBATS", ExchangeEquityBATS) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeForex", ExchangeForex) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionNYSEAMEX", ExchangeOptionNYSEAMEX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionBOSTON", ExchangeOptionBOSTON) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionCBOE", ExchangeOptionCBOE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionEDGX", ExchangeOptionEDGX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionISEGEMINI", ExchangeOptionISEGEMINI) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionISE", ExchangeOptionISE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionISEMERCURY", ExchangeOptionISEMERCURY) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionMIAMI", ExchangeOptionMIAMI) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionNYSEARCA", ExchangeOptionNYSEARCA) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionOPRA", ExchangeOptionOPRA) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionMIAXPEARL", ExchangeOptionMIAXPEARL) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionNASDAQ", ExchangeOptionNASDAQ) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionNASDAQBX", ExchangeOptionNASDAQBX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionC2", ExchangeOptionC2) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionNASDAQPHLX", ExchangeOptionNASDAQPHLX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeOptionBATS", ExchangeOptionBATS) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeIndexCBOE", ExchangeIndexCBOE) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeFutureCBOT", ExchangeFutureCBOT) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeFutureCME", ExchangeFutureCME) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeFutureNYMEX", ExchangeFutureNYMEX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeFutureCOMEX", ExchangeFutureCOMEX) );
    this->m_strToExchange.insert( std::pair<std::string, ATExchangeType>("ExchangeFutureKCBT", ExchangeFutureKCBT) );
    
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeComposite, 0) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNYSEMKT, 1) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNASDAQBX, 2) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNSE, 3) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityFINRA, 4) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityCQS, 5) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityISE, 6) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityEDGA, 7) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityEDGX, 8) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityCSE, 9) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNYSE, 10) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNYSEARCA, 11) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNASDAQ, 12) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityCTS, 13) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityOTC, 14) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityIEX, 15) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityCBOE, 16) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityNASDAQPHLX, 17) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityBATSY, 18) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeEquityBATS, 19) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeForex, 20) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionNYSEAMEX, 21) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionBOSTON, 22) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionCBOE, 23) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionEDGX, 24) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionISEGEMINI, 25) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionISE, 26) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionISEMERCURY, 27) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionMIAMI, 28) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionNYSEARCA, 29) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionOPRA, 30) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionMIAXPEARL, 31) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionNASDAQ, 32) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionNASDAQBX, 33) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionC2, 34) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionNASDAQPHLX, 35) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeOptionBATS, 36) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeIndexCBOE, 37) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeFutureCBOT, 38) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeFutureCME, 39) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeFutureNYMEX, 40) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeFutureCOMEX, 41) );
    // this->m_ExchangeToInt.insert( std::pair<ATExchangeType, int>(ExchangeFutureKCBT, 42) );
